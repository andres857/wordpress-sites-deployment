...
services:
  nginx:
    ...
    volumes:
      ...
      - ./html:/var/www/html
    environment:
      - VIRTUAL_HOST=$wpdomain, www.$wpdomain
      - LETSENCRYPT_HOST=$wpdomain, www.$wpdomain
...
server {
    listen 80;
    server_name www.$wpdomain;

    return 301 \$scheme://$wpdomain\$request_uri;
}
server {
    listen 80;
    server_name $wpdomain www.$wpdomain;
    root /var/www/html;
    index index.php;
